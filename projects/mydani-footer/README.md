...
To use the mydani-footer component in your project, simply add the following tag to your HTML      
file where you want the footer to appear:    



<lib-mydani-footer
  [footerColor]="'#F8F5E4'"
  [footerText]="'DGO 2023 ©Danideveloperweb'"
  [textColor]="'red'"
...
You can customize the footer style by modifying the styles in your global CSS file       
or in the specific style file for your component.         
